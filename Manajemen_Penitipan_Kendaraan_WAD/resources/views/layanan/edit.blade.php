        ...
        <div class="col-md-8">
            <div class="card shadow-lg border-0">
                <div class="card-header">
                    <h4 class="mb-0">{{ __('Edit Layanan') }}</h4>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('layanan.update', $layanan->id) }}" id="layananForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input id="nama_layanan" type="text" 
                                   ...
                                   name="nama_layanan" value="{{ old('nama_layanan', $layanan->nama_layanan) }}" 
                                   required autofocus>
                            @error('nama_layanan')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="harga_motor" type="number" 
                                               ...
                                               name="harga_motor" value="{{ old('harga_motor', $layanan->harga_motor) }}" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="harga_mobil" type="number" 
                                               ...
                                               name="harga_mobil" value="{{ old('harga_mobil', $layanan->harga_mobil) }}" 
                                               required min="0" onchange="updateTotalHarga()">
                                    </div>
                                    @error('harga_mobil')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input id="durasi_nilai" type="number" 
                                           ...
                                           name="durasi_nilai" value="{{ old('durasi_nilai', $layanan->durasi_nilai) }}" 
                                ...
                                <div class="col-md-6">
                                    <select id="durasi_tipe" 
                                        ...
                                        <option value="hari" {{ old('durasi_tipe', $layanan->durasi_tipe) == 'hari' ? 'selected' : '' }}>
                                            {{ __('Hari') }}
                                        </option>
                                        <option value="bulan" {{ old('durasi_tipe', $layanan->durasi_tipe) == 'bulan' ? 'selected' : '' }}>
                                            {{ __('Bulan') }}
                                        </option>
                                    </select>
                                    @error('durasi_tipe')
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>{{ __('Perbarui Layanan') }}
                            </button>
                        </div>
                    </form>
                </div>
