                    ...
                    <form method="POST" action="{{ route('layanan.update', $layanan->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="harga_motor" class="form-control" value="{{ old('harga_motor', $layanan->harga_motor) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input type="number" name="harga_mobil" class="form-control" value="{{ old('harga_mobil', $layanan->harga_mobil) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="durasi_nilai" class="form-control" value="{{ old('durasi_nilai', isset($layanan->durasi_nilai) ? $layanan->durasi_nilai : $layanan->durasi) }}" min="1" required>
                                <select name="durasi_tipe" class="form-select" required>
                                    <option value="hari" {{ old('durasi_tipe', isset($layanan->durasi_tipe) ? $layanan->durasi_tipe : 'hari') == 'hari' ? 'selected' : '' }}>Hari</option>
                                    <option value="bulan" {{ old('durasi_tipe', isset($layanan->durasi_tipe) ? $layanan->durasi_tipe : '') == 'bulan' ? 'selected' : '' }}>Bulan</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="jenis_kendaraan" class="form-select" required>
                                ...
                                <option value="motor" {{ old('jenis_kendaraan', $layanan->jenis_kendaraan) == 'motor' ? 'selected' : '' }}>Motor</option>
                                <option value="mobil" {{ old('jenis_kendaraan', $layanan->jenis_kendaraan) == 'mobil' ? 'selected' : '' }}>Mobil</option>
                            </select>
                        </div>
